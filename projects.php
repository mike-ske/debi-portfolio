    ...
    <div class="fg_center">
        <div class="splide" id="splide">
            <div class="splide__arrows">
                <button class="splide_arrow splide__arrow--prev">
                    <img src="./img/left-arrow.png" alt="">
                </button>
                <button class="splide_arrow splide__arrow--next">
...
<script>
    ...
    let slide = new Splide(elms, {
        ...
        classes: {
            ...
            prev: 'splide__arrow--prev my-splide-prev',
            next: 'splide__arrow--next my-splide-next'
        }
    });
